...
public class ArticoloServiceImpl implements ArticoloService {
	...
	public Articolo caricaEagerDaID(Long id) throws Exception {
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return articoloDAO.findByIdEager(id);
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		} finally {
	...
	@Override
	public void rimuoviEScollegaTutto(Long idArticolo) throws Exception {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			// eseguo quello che realmente devo fare
			articoloDAO.deleteAndUnlinkAll(idArticolo);
	...
	@Override
	public Articolo caricaUltimoID() throws Exception {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
	...
	@Override
	public int sommaPrezzoArticoliByCategoria(Long idCategoria) throws Exception {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return articoloDAO.sumPrezzoArticoliByCategoria(idCategoria);
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		} finally {
	...
	@Override
	public int sommaPrezziByDestinatario(String nomeDestinatario) throws Exception {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
	...
	@Override
	public List<Articolo> trovaByOrdineError() throws Exception {
		// questo è come una connection
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		...
		try {
			...
			// eseguo quello che realmente devo fare
			return articoloDAO.findByOrdineError();
		} catch (Exception e) {
			e.printStackTrace();
			throw e;
		} finally {
